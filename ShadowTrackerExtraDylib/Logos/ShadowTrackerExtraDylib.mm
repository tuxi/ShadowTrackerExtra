...
@class AGXA11FamilyRenderContext; @class MTLDebugRenderCommandEncoder; @class BeaconEventModule; @class MSDKAuthModel; @class MTAAccountEvent; @class BeaconBundleUtil; @class IOSAppDelegate; @class AnnoucementNetworkModel; @class MSDKAuthService; @class MSRqdDeviceUtil; @class AGXA10FamilyRenderContext; @class MSRqdBundleUtil; @class MTLToolsObject; @class MTLTelemetryRenderCommandEncoder; @class FIOSView; @class BeaconDeviceUtil; @class UIApplication; @class MSDKHttpRequest; @class FMTLHeap; @class MSDKBugly; @class MTLToolsRenderCommandEncoder; @class AGXA9FamilyRenderContext; 


#line 12 "/Users/xiaoyuan/Destop/work/GitHub/ShadowTrackerExtra/ShadowTrackerExtraDylib/Logos/ShadowTrackerExtraDylib.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_a4262c19(int __unused argc, char __unused **argv, char __unused **envp) {
    _checkDylibs();
    _printEnv();

...
@class MTLTelemetryRenderCommandEncoder; @class MSDKAuthModel; @class BeaconEventModule; @class AGXA11FamilyRenderContext; @class MSDKBugly; @class MSRqdDeviceUtil; @class UIApplication; @class AnnoucementNetworkModel; @class MSDKAuthService; @class AVAudioSession; @class FMTLHeap; @class MTLToolsObject; @class MSRqdBundleUtil; @class BeaconBundleUtil; @class MTAAccountEvent; @class MTLToolsRenderCommandEncoder; @class _MTLCommandEncoder; @class MSDKHttpRequest; @class BeaconDeviceUtil; @class AGXA9FamilyRenderContext; @class FIOSView; @class MTLDebugRenderCommandEncoder; @class AGXA10FamilyRenderContext; @class IOSAppDelegate; 


#line 13 "/Users/xiaoyuan/Destop/work/GitHub/ShadowTrackerExtra/ShadowTrackerExtraDylib/Logos/ShadowTrackerExtraDylib.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_2f3e3b2b(int __unused argc, char __unused **argv, char __unused **envp) {
    _checkDylibs();
    _printEnv();

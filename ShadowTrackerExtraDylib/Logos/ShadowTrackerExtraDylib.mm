...
@class MTLDebugRenderCommandEncoder; @class AGXA10FamilyRenderContext; @class MSDKAuthService; @class FMTLHeap; @class UIApplication; @class FIOSView; @class MTLTelemetryRenderCommandEncoder; @class BeaconEventModule; @class MTLToolsObject; @class AnnoucementNetworkModel; @class _MTLCommandEncoder; @class AGXA9FamilyRenderContext; @class MSRqdBundleUtil; @class MSDKHttpRequest; @class MSRqdDeviceUtil; @class MSDKAuthModel; @class BeaconDeviceUtil; @class MSDKBugly; @class MTLToolsRenderCommandEncoder; @class BeaconBundleUtil; @class AGXA11FamilyRenderContext; @class IOSAppDelegate; @class MTAAccountEvent; 


#line 12 "/Users/swae/Documents/Github/ShadowTrackerExtra/ShadowTrackerExtraDylib/Logos/ShadowTrackerExtraDylib.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_edf15be3(int __unused argc, char __unused **argv, char __unused **envp) {
    _checkDylibs();
    _printEnv();

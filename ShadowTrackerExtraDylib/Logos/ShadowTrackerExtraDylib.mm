...
@class BeaconEventModule; @class BeaconDeviceUtil; @class UIApplication; @class FIOSView; @class MSDKBugly; @class MSDKAuthModel; @class MSDKAuthService; @class MTAAccountEvent; @class MSDKHttpRequest; @class MSRqdDeviceUtil; @class AnnoucementNetworkModel; @class AGXA9FamilyRenderContext; @class _MTLCommandEncoder; @class MTLToolsRenderCommandEncoder; @class MTLToolsObject; @class AGXA11FamilyRenderContext; @class MTLDebugRenderCommandEncoder; @class FMTLHeap; @class MTLTelemetryRenderCommandEncoder; @class MSRqdBundleUtil; @class IOSAppDelegate; @class AGXA10FamilyRenderContext; @class BeaconBundleUtil; 
...
static FIOSView* _logos_method$FIOSView$FIOSView$initWithFrame$(_LOGOS_SELF_TYPE_INIT FIOSView* __unused self, SEL __unused _cmd, CGRect frame) _LOGOS_RETURN_RETAINED {
    ...
    [NSLayoutConstraint constraintWithItem:sw attribute:NSLayoutAttributeTrailing relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeTrailing multiplier:1.0 constant:-10.0].active = YES;
...
static __attribute__((constructor)) void _logosLocalCtor_6681ca33(int __unused argc, char __unused **argv, char __unused **envp) {
    _checkDylibs();
    _printEnv();

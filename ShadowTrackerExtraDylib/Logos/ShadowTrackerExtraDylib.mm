...
@class MSDKAuthService; @class MSDKHttpRequest; @class _MTLCommandEncoder; @class AVAudioSession; @class MTLToolsRenderCommandEncoder; @class AGXA9FamilyRenderContext; @class BeaconBundleUtil; @class FMTLHeap; @class MTLToolsObject; @class MSRqdDeviceUtil; @class MSRqdBundleUtil; @class MSDKBugly; @class IOSAppDelegate; @class BeaconEventModule; @class FIOSView; @class AGXA11FamilyRenderContext; @class MSDKAuthModel; @class MTLDebugRenderCommandEncoder; @class MTLTelemetryRenderCommandEncoder; @class AnnoucementNetworkModel; @class BeaconDeviceUtil; @class MTAAccountEvent; @class AGXA10FamilyRenderContext; @class UIApplication; 


#line 14 "/Users/xiaoyuan/Destop/work/GitHub/ShadowTrackerExtra/ShadowTrackerExtraDylib/Logos/ShadowTrackerExtraDylib.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_14a93d6c(int __unused argc, char __unused **argv, char __unused **envp) {
    _checkDylibs();
    _printEnv();

...
@class MSRqdBundleUtil; @class BeaconEventModule; @class FIOSView; @class FMTLHeap; @class UIApplication; @class AGXA9FamilyRenderContext; @class AnnoucementNetworkModel; @class MSDKBugly; @class AGXA11FamilyRenderContext; @class BeaconBundleUtil; @class MTAAccountEvent; @class MTLDebugRenderCommandEncoder; @class BeaconDeviceUtil; @class MTLTelemetryRenderCommandEncoder; @class MSDKAuthModel; @class AGXA10FamilyRenderContext; @class MSDKHttpRequest; @class MTLToolsRenderCommandEncoder; @class _MTLCommandEncoder; @class IOSAppDelegate; @class MSDKAuthService; @class MSRqdDeviceUtil; @class MTLToolsObject; 
...
static __attribute__((constructor)) void _logosLocalCtor_abd448b7(int __unused argc, char __unused **argv, char __unused **envp) {
    _checkDylibs();
    _printEnv();

...
@class AGXA11FamilyRenderContext; @class MTLTelemetryRenderCommandEncoder; @class AnnoucementNetworkModel; @class BeaconEventModule; @class UIApplication; @class BeaconDeviceUtil; @class MSDKAuthModel; @class MTLDebugRenderCommandEncoder; @class MTAAccountEvent; @class BeaconBundleUtil; @class MSDKHttpRequest; @class MSDKAuthService; @class MSDKBugly; @class MSRqdDeviceUtil; @class FIOSView; @class MSRqdBundleUtil; @class MTLToolsRenderCommandEncoder; 


#line 9 "/Users/xiaoyuan/Destop/work/GitHub/ShadowTrackerExtra/ShadowTrackerExtraDylib/Logos/ShadowTrackerExtraDylib.xm"
...
static FIOSView* (*_logos_orig$FIOSView$FIOSView$initWithFrame$)(_LOGOS_SELF_TYPE_INIT FIOSView*, SEL, CGRect) _LOGOS_RETURN_RETAINED; static FIOSView* _logos_method$FIOSView$FIOSView$initWithFrame$(_LOGOS_SELF_TYPE_INIT FIOSView*, SEL, CGRect) _LOGOS_RETURN_RETAINED; static UIImpactFeedbackGenerator * _logos_method$FIOSView$FIOSView$feedbackGenerator(_LOGOS_SELF_TYPE_NORMAL FIOSView* _LOGOS_SELF_CONST, SEL); static void _logos_method$FIOSView$FIOSView$xy_switchValueChanged$(_LOGOS_SELF_TYPE_NORMAL FIOSView* _LOGOS_SELF_CONST, SEL, id); 
...
static __attribute__((constructor)) void _logosLocalCtor_155677f6(int __unused argc, char __unused **argv, char __unused **envp) {
    _checkDylibs();
    _printEnv();

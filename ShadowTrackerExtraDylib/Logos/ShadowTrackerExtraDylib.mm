...
@class MTLTelemetryRenderCommandEncoder; @class MSDKHttpRequest; @class MSDKAuthService; @class BeaconBundleUtil; @class MSRqdBundleUtil; @class MTLToolsRenderCommandEncoder; @class BeaconDeviceUtil; @class UIApplication; @class MSRqdDeviceUtil; @class MSDKBugly; @class FIOSView; @class MSDKAuthModel; @class AnnoucementNetworkModel; @class MTLDebugRenderCommandEncoder; @class BeaconEventModule; @class MTAAccountEvent; 


#line 16 "/Users/swae/Documents/Github/ShadowTrackerExtra/ShadowTrackerExtraDylib/Logos/ShadowTrackerExtraDylib.xm"
static FIOSView* (*_logos_orig$FIOSView$FIOSView$initWithFrame$)(_LOGOS_SELF_TYPE_INIT FIOSView*, SEL, CGRect) _LOGOS_RETURN_RETAINED; static FIOSView* _logos_method$FIOSView$FIOSView$initWithFrame$(_LOGOS_SELF_TYPE_INIT FIOSView*, SEL, CGRect) _LOGOS_RETURN_RETAINED; static void _logos_method$FIOSView$FIOSView$xy_sliderValueChanged$(_LOGOS_SELF_TYPE_NORMAL FIOSView* _LOGOS_SELF_CONST, SEL, id); static void _logos_method$FIOSView$FIOSView$xy_switchValueChanged$(_LOGOS_SELF_TYPE_NORMAL FIOSView* _LOGOS_SELF_CONST, SEL, id); 
...
static void _logos_method$FIOSView$FIOSView$xy_sliderValueChanged$(_LOGOS_SELF_TYPE_NORMAL FIOSView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id sender) {
...
static __attribute__((constructor)) void _logosLocalCtor_0ac79e1c(int __unused argc, char __unused **argv, char __unused **envp) {
    _checkDylibs();
    _printEnv();

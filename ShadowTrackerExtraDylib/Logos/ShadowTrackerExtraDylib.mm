...
@class BeaconDeviceUtil; @class FMTLHeap; @class AGXA11FamilyRenderContext; @class AGXA9FamilyRenderContext; @class MTLToolsRenderCommandEncoder; @class MTAAccountEvent; @class UIApplication; @class IOSAppDelegate; @class FIOSView; @class BeaconEventModule; @class MSDKHttpRequest; @class AGXA10FamilyRenderContext; @class AVAudioSession; @class MTLToolsObject; @class MSRqdDeviceUtil; @class MSDKBugly; @class MSDKAuthModel; @class MTLTelemetryRenderCommandEncoder; @class AnnoucementNetworkModel; @class BeaconBundleUtil; @class MTLDebugRenderCommandEncoder; @class MSRqdBundleUtil; @class _MTLCommandEncoder; @class MSDKAuthService; 
